...
const Profile = props => {
  ...
  const { profileInfo, profileInfo: { photos }, submitProfileInfo,
    profileStatus, updateProfileStatus, setProfilePhoto, isOwner, updateProfileInfoSuccess } = props
  ...
  return <div className={style.descriptionBlock}>
    <div>
      <img src={photos.large || userIcon} alt="User Image" className={style.userImg} />
    ...
    {editMode
      ? <ProfileInfoForm initialValues={profileInfo} profileInfo={profileInfo} submitProfileInfo={submitProfileInfo} />
      : <ProfileInfo profileInfo={profileInfo} isOwner={isOwner} setEditMode={setEditMode} />}
